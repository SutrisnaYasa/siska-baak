...
@router.get('/', response_model = List[schemas.ShowRuangan], status_code = status.HTTP_200_OK)
...
@router.get('/{id}', status_code = status.HTTP_200_OK, response_model = schemas.ShowRuangan)
